...
public class ProductCatalogAdapter extends BaseAdapter {
    ...
    public ProductCatalogAdapter(CustomerAppBaseActivity activity, List<Product> products) {
    ...
    private void setData(final ViewHolder holder, final Product product) {
        ...
        holder.tvPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                totalQuantity++;
                if (iProductCatalog != null)
                    iProductCatalog.finalProductQuantity(totalQuantity);
            }
        });
    ...
    private IProductCatalog iProductCatalog;

    public void setListener(IProductCatalog iProductCatalog) {
        this.iProductCatalog = iProductCatalog;
    }
