...
public class MyOrderDetailActivity extends BaseActivity {
    ...
    private void setOtherUI(OrderDetail order) {
        ...
        if (isFindOrder(orderStatus, acceptedByCustomer)) {
            ...
            tv_order_detail_acc_by_customer.setText(order.getOrderReceiptAcknowledgement() == "N" ? "No":"Yes");
        } else {
        ...
        if (orderStatus.equalsIgnoreCase("Closed")) {
            ...
            tv_order_detail_invoke_amount_collected.setText(order.getOrderInvoiceAmountCollected() == "N" ? "No":"Yes");
        } else {
