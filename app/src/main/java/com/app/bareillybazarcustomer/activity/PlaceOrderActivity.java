...
import com.app.bareillybazarcustomer.adapter.PlaceOrderAdapter;
import com.app.bareillybazarcustomer.api.input.Cart;
...
import com.app.bareillybazarcustomer.api.output.PaymentMethod;
...
public class PlaceOrderActivity extends BaseActivity {
    ...
    private void seSpinnerTime(List<PaymentMethod> paymentMethods) {
        ...
        timeMiliSecond.add(getString(R.string.label_anytime));
        categories.add(getString(R.string.label_anytime));
    ...
    private void getIntentData() {
        ...
        if (products == null || orders == null) {
            ...
            no_data_available.setText(getString(R.string.msg_empty_cart));
    ...
    private void placeOrderApi() {
        ...
        if (customerAddresses == null) {
            DialogUtils.showDialogNetwork(this, getString(R.string.msg_no_address_found), new IDialogListener() {
                @Override
            ...
            if (timeStampData != null) {
                ...
                order.setOrderStatus(AppConstant.STATUS.STATUS_ORDERED);
                ...
                if(timeStampData.equals(getString(R.string.label_anytime))) {
                    order.setOrderExpectedDeliveryTimestamp(timeStampData);
                }
                else {
