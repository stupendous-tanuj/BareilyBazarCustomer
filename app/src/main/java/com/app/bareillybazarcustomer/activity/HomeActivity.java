...
import com.app.bareillybazarcustomer.fragment.HomeFragment;
...
import com.app.bareillybazarcustomer.utils.RoundedImageView;
...
public class HomeActivity extends BaseActivity {
    ...
    private void setHamberData() {
        Log.i("Mob", PreferenceKeeper.getInstance().getuserMobileNumber());
        ...
        Log.i("Pic", PreferenceKeeper.getInstance().getUserProfilePicturePath());
