...
public class DialogUtils {
    ...
    public static boolean isOTPVarification(BaseActivity activity, String otpEdit, String otpNumber) {
    ...
    public static boolean isLoginDetailSkip(BaseActivity activity, String name, String email) {
    ...
    public static boolean isLoginDetailVerify(BaseActivity activity, String name, String email, String flatNumber, String area,
